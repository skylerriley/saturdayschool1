...
import { HandicapsManager } from "./HandicapsManager";
...
import { BeatHistoryRebuild } from "./BeatHistoryRebuild";
...
export function AdminTab({ golfers, setGolfers, courses, setCourses, events, setEvents, signups, setSignups, leaderboard, setLeaderboard, holeScores, setHoleScores, dbUpsertLeaderboard, dbUpsertHoleScore, charityDonations, setCharityDonations, holeImages, setHoleImages, showSuccess, scrollToTop }: any) {
  ...
  const ADMIN_TABS = [
    { id: "events" }, { id: "hcp" }, { id: "scores" }, { id: "payouts" }, { id: "courses" }, { id: "roster" }, { id: "message" },
  ];
  return (
    <div className="admin-styled">
      ...
      <SubTabPanel tabs={ADMIN_TABS} value={subTab}>
        {subTab === "events" && (
          <EventsManager courses={courses} events={events} setEvents={setEvents} signups={signups} setSignups={setSignups} leaderboard={leaderboard} setLeaderboard={setLeaderboard} golfers={golfers} showSuccess={showSuccess} scrollToTop={scrollToTop}>
            <AiRecapBackfill events={events} showSuccess={showSuccess} />
            <BeatHistoryRebuild events={events} courses={courses} signups={signups} golfers={golfers} leaderboard={leaderboard} holeScores={holeScores} showSuccess={showSuccess} />
          </EventsManager>
        )}
        {subTab === "hcp" && <HandicapsManager golfers={golfers} setGolfers={setGolfers} courses={courses} showSuccess={showSuccess} />}
